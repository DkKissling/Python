...
Original file is located at
    https://colab.research.google.com/drive/1d6i2RI3rs0e8yViG8ia_MD-qFjj-Q_G7
...
y_pred==y
print('Prediccion:',accuracy_score(y,y_pred))
...
# Crear el gráfico con la matriz normalizada
disp = ConfusionMatrixDisplay(confusion_matrix=cm_normalized, display_labels=arbol.classes_)
...
plot_tree(arbol,filled=True,feature_names=X.columns,class_names=["No","Si"])
plt.show()
