...
Original file is located at
    https://colab.research.google.com/drive/1bhAlYSRmDkb0G-TnbtEXODKhujEw1H-V
...
array_unidim.shape, array_unidim.ndim, array_unidim.size,type(array_unidim)

# Atributos del array bidimensional
array_bidim.shape, array_bidim.ndim, array_bidim.size,type(array_bidim)

# Atributos del array tridimensional
array_tridim.shape, array_tridim.ndim, array_tridim.size,type(array_tridim)
...
# Hallamos el promedio de los valores del
np.mean(array_10)
